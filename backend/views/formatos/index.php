								...
								<div class="card card-custom">
									<div class="card-header card-header-tabs-line">
										...
										<div class="card-toolbar">
											...
											<!--begin::Button-->
											<a href="<?= Url::to(['formatos/create']); ?>/" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i>Crear Formato</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
...
$text_test = "common.basePath = '". $local->baseUrl ."/';".
             "common.initDataTable($('#kt_datatable'),'". Url::to(['formatos/pagina']) ."','". Url::to(['formatos/update']) ."',".
...
?>
<script>
var url_delete='<?=Url::to(['formatos/delete']);?>';
</script>