        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                                <!--begin::Page Title-->
                                <h5 class="text-dark font-weight-bold my-1 mr-5">Medicamentos</h5>
                                <!--end::Page Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item text-muted">
                                                <a href="<?= Url::to(['pacientes/']); ?>/" class="text-muted">Catalogos</a>
                                        </li>
                                        <li class="breadcrumb-item text-muted">
								...
								<div class="card card-custom">
									<div class="card-header card-header-tabs-line">
										...
										<div class="card-toolbar">
											...
											<!--begin::Button-->
											<a href="<?= Url::to(['medicamentos/create']); ?>/" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i>Crear Medicamento</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
...
$text_test = "common.basePath = '". $local->baseUrl ."/';".
             "common.initDataTable($('#kt_datatable'),'". Url::to(['medicamentos/pagina']) ."','". Url::to(['medicamentos/update']) ."',".
...
?>
<script>
var url_delete='<?=Url::to(['medicamentos/delete']);?>';
</script>