        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                                <!--begin::Page Title-->
                                <h5 class="text-dark font-weight-bold my-1 mr-5">Doctores</h5>
                                <!--end::Page Title-->
                                <!--begin::Breadcrumb-->
								...
								<div class="card card-custom">
									<div class="card-header card-header-tabs-line">
										...
										<div class="card-toolbar">
											...
											<!--begin::Button-->
											<a href="<?= Url::to(['doctores/create']); ?>/" class="btn btn-primary font-weight-bolder">
											<i class="la la-plus"></i>Agregar Doctor</a>
											<!--end::Button-->
										</div>
									</div>
									<div class="card-body">
...
$text_test = "common.basePath = '". $local->baseUrl ."/';".
             "common.initDataTable($('#kt_datatable'),'". Url::to(['doctores/pagina']) ."','". Url::to(['doctores/update']) ."',".
...
?>
<script>
var url_delete='<?=Url::to(['doctores/delete']);?>';
</script>