    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <span class='imageuploadify-message'>Arrastre sus archivos</span>
          <button type="button" class="btn btn-default">o Seleccione los archivos</button>
        </div>
      </div>
      `);
      ...
      const readingFile = (id, file) => {
        ...
        if (file.type && file.type.search(/image/) != -1) {
          ...
          fReader.onloadend = function (e) {
            ...
            let spantext = $("<span style='font-size:10px'>" + file.name + "</span>");
